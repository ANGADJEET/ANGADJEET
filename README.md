...
- [Daily Harbour](GitHub_Link): E-commerce platform with Flask backend and responsive frontend
- [CryptoVision](GitHub_Link): Cryptocurrency forecasting app using ML models
- [Stick-Hero](GitHub_Link): Java-based game showcasing OOP and multithreading
- [SysShell](GitHub_Link): Custom Unix shell with advanced process scheduling

## 🤝 Open for Collaboration

I'm always excited to work on innovative projects and contribute to open-source initiatives. Feel free to reach out if you'd like to collaborate!

## 📫 Connect with Me

[LinkedIn](Your_LinkedIn_Profile) | [Portfolio](Your_Portfolio_Link)
